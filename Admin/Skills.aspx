<%@ Page Title="Skills" Language="C#" MasterPageFile="~/Admin/MainAdminView.Master" AutoEventWireup="true" CodeFile="Skills.aspx.cs" Inherits="Admin_Skills" %>


<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %></h2>

    <asp:GridView class="table" Style="margin: 0 auto;" ID="GridView1" runat="server" AllowPaging="true" PageSize="5" OnPageIndexChanging="OnPaging" AllowSorting="true" AutoGenerateColumns="False" DataKeyNames="ID_Skill"
