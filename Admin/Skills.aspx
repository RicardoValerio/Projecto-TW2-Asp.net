...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView class="table" Style="margin: 0 auto;" ID="GridView1" runat="server" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="False" DataKeyNames="ID_Skill"
