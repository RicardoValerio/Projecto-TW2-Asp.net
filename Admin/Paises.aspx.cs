...
public partial class Admin_Paises : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        using ( SqlConnection con = new SqlConnection( constr ) ) {
            using ( SqlCommand cmd = new SqlCommand( "Paises_CRUD" ) ) {
    ...
    protected void Insert( object sender, EventArgs e )
    {
        ...
        using ( SqlConnection con = new SqlConnection( constr ) ) {
            using ( SqlCommand cmd = new SqlCommand( "Paises_CRUD" ) ) {
                ...
                cmd.Parameters.AddWithValue( "@Nome", country );
                cmd.Connection = con;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
    ...
    protected void OnRowUpdating( object sender, GridViewUpdateEventArgs e )
    {
        ...
        int IdPais = Convert.ToInt32( GridView1.DataKeys[e.RowIndex].Values[0] );
